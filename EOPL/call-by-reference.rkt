...
; call-by-reference only in apply-procedure
; let-exp and assign-exp make a new variable
; 1. var-ref deref to get actual value
; 1. let-exp variable with initialization value
; 1. assign-exp update ref value with assigned value
; 1. apply-procedure pass ref directly when operand is var-exp, new ref otherwise.
...
") 1 "x and y are two standalone variable, changing y doesn't affect x")
...
") 11 "call by reference, swap two variables")
