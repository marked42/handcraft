 ...
 */
var productions = [[-1, 1, function (_1) { __ = _1; }],
    [0, 1, function (_1) { __ = _1; }],
    [0, 1, function (_1) { __ = _1; }],
    [1, 1, function (_1) { __ = Number(_1); }],
    [1, 1, function (_1) { __ = _1 === 'true' ? true : false; }],
    [1, 1, function (_1) { __ = _1; }],
    [1, 1, function (_1) { __ = _1; }],
    [2, 3, function (_1, _2, _3) { __ = _2; }],
    [3, 2, function (_1, _2) { _1.push(_2); __ = _1; }],
    [3, 0, function () { __ = []; }]];
/**
 * Encoded tokens map.
 */
var tokens = { "NUMBER": "4", "BOOLEAN": "5", "STRING": "6", "SYMBOL": "7", "'('": "8", "')'": "9", "$": "10" };
/**
 * Parsing table (generated by Syntax tool).
 */
var table = [{ "0": 1, "1": 2, "2": 3, "4": "s4", "5": "s5", "6": "s6", "7": "s7", "8": "s8" }, { "10": "acc" }, { "4": "r1", "5": "r1", "6": "r1", "7": "r1", "8": "r1", "9": "r1", "10": "r1" }, { "4": "r2", "5": "r2", "6": "r2", "7": "r2", "8": "r2", "9": "r2", "10": "r2" }, { "4": "r3", "5": "r3", "6": "r3", "7": "r3", "8": "r3", "9": "r3", "10": "r3" }, { "4": "r4", "5": "r4", "6": "r4", "7": "r4", "8": "r4", "9": "r4", "10": "r4" }, { "4": "r5", "5": "r5", "6": "r5", "7": "r5", "8": "r5", "9": "r5", "10": "r5" }, { "4": "r6", "5": "r6", "6": "r6", "7": "r6", "8": "r6", "9": "r6", "10": "r6" }, { "3": 9, "4": "r9", "5": "r9", "6": "r9", "7": "r9", "8": "r9", "9": "r9" }, { "0": 11, "1": 2, "2": 3, "4": "s4", "5": "s5", "6": "s6", "7": "s7", "8": "s8", "9": "s10" }, { "4": "r7", "5": "r7", "6": "r7", "7": "r7", "8": "r7", "9": "r7", "10": "r7" }, { "4": "r8", "5": "r8", "6": "r8", "7": "r8", "8": "r8", "9": "r8" }];
/**
 * Parsing stack.
 */
var stack = [];
...
var lexRulesByConditions = { "INITIAL": [0, 1, 2, 3, 4, 5, 6] };
var EOF_TOKEN = {
    type: EOF,
    value: '',
};
tokenizer = {
    ...
    throwUnexpectedToken: function (symbol, line, column) {
        ...
        throw new SyntaxError("".concat(lineData, "Unexpected token: \"").concat(symbol, "\" ") +
            "at ".concat(line, ":").concat(column, "."));
    },
    getCursor: function () {
        return this._cursor;
    },
    ...
    parse: function (string, parseOptions) {
        ...
        do {
            ...
            // Reduce action.
                ...
                var locationArgs = (hasSemanticAction && yy.options.captureLocations
                    ? []
                    : null);
                if (production[1] !== 0) {
                ...
                if (hasSemanticAction) {
                    ...
                    var semanticActionArgs = (locationArgs !== null
