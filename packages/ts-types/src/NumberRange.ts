...
//         ? [...R, R["length"]]
//         : R
//     : NumberRangeFromZero<N, Inclusive, [...R, R["length"]]>;

// type NumberRange<L extends number, H extends number> = keyof {
//     [P in keyof NumberRangeFromZero<
//         H,
//         true
//     > as P extends keyof NumberRangeFromZero<L, false>
//         ? never
//         : P]: NumberRangeFromZero<H, true>[P];
// };
